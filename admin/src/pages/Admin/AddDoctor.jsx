            ...
            <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
                ...
                <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
                    <div className="w-full lg-flex-1 flex flex-col gap-4">
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                            ...
                            <select onChange={(e) => setExperience(e.target.value)} value={experience}
                                    className="border rounded px-3 py-2" name="" id="experience">
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                            ...
                            <input onChange={(e) => setFees(e.target.value)} value={fees}
                                   className="border rounded px-3 py-2" type="number" placeholder="Fee"/>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg-flex-1 flex flex-col gap-4">
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                            <p>Education</p>
                            <input onChange={(e) => setDegree(e.target.value)} value={degrees}
                ...
                <button type="submit" className="bg-blue-900 px-10 py-3 mt-4 text-white rounded-full">Add doctor</button>
